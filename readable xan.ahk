...
Gui, Tab, Credits
Gui, Add, GroupBox, x10 y50 w460 h141, Credits
Gui, Add, Text, x20 y70, Developed by Hu6 | Ares | Lunar`nOriginal macro by AsphaltCake | Fisch V11`nMacro changes by Lunarosity`nGUI by Ares and Lunarosity | GUI inspired by 0x3b5`nFurther Minigame Improvements by Hu6`nConfig by Hu6 Partly Inspired by Texture`nShoutout NotWizzy

Gui, Tab, Webhook
Gui Add,Text, x4 y100 w100 h30,  Sorry for Delay <3
...
Gui, Add, Button, gLoadSettings x105 h25 y200, Load settings | Closes GUI and continues to macro
...
SaveSettings:
    ...
    IniWrite, %enablewebhook%, Settings,ini, Settings, enable-webhook
    IniWrite, %webhookurl%, Settings.ini, Settings, webhook-url
...
LoadSettings:
    ...
    IniRead, inienablewebhook, Settings.ini, Settings, enable-webhook, 0
    IniRead, iniwebhookurl, Settings.ini, settings, webhook-url, 0
...
GuiClose:
    ...
    StabilizerLoop := 40
    SideBarRatio := 0.8
    StableRightMultiplier := 2.5821
    StableRightDivision := 1.8961
    StableLeftMultiplier := 2.9892
    StableLeftDivision := 4.6235
